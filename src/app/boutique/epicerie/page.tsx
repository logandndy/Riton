...
export default function Epicerie() {
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      ...
      const epicerieProducts = getProductsByCategory(allProducts, 'epicerie');
      setProducts(epicerieProducts);
      setFilteredProducts(epicerieProducts);
      setCategories(['epicerie']);
    };
    fetchProducts();
  }, []);
